            ...
            <div class="p-8 text-gray-900">
                ...
                <form method="POST" action="{{ route('usuarios.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full border-gray-300 focus:border-multirao-roxo focus:ring-multirao-roxo rounded-md shadow-sm" type="text" name="name" :value="old('name')" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-1 w-full border-gray-300 focus:border-multirao-roxo focus:ring-multirao-roxo rounded-md shadow-sm" type="email" name="email" :value="old('email')" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Senha -->
                        <div>
                            <x-input-label for="password" :value="__('Senha')" class="text-multirao-roxo font-bold uppercase text-xs" />
                            <x-text-input id="password" class="block mt-1 w-full border-gray-300 focus:border-multirao-roxo focus:ring-multirao-roxo rounded-md shadow-sm" type="password" name="password" required />
                            <x-input-error :messages="$errors->get('password')" class="mt-2" />
                        </div>

                        <!-- Confirmar Senha -->
                        <div>
                            <x-input-label for="password_confirmation" :value="__('Confirmar Senha')" class="text-multirao-roxo font-bold uppercase text-xs" />
                            <x-text-input id="password_confirmation" class="block mt-1 w-full border-gray-300 focus:border-multirao-roxo focus:ring-multirao-roxo rounded-md shadow-sm" type="password" name="password_confirmation" required />
